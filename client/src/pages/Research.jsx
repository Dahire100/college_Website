...
export default function Research({ settings = {}, onNavigate }) {
  ...
  return (
    <div style={{ background: '#F8FAFC', minHeight: '100vh', paddingBottom: '5rem' }}>
      <section style={{ background: 'linear-gradient(135deg, #0B1E36 0%, #153A6B 100%)', color: '#FFFFFF', padding: '5rem 0 4.5rem 0', borderBottom: '4px solid #D97706' }}>
      ...
      <div className="container" style={{ marginTop: '2.5rem' }}>
        <div style={{ display: 'flex', gap: '0.5rem', borderBottom: '2px solid #E2E8F0', paddingBottom: '0.5rem', marginBottom: '2.5rem', overflowX: 'auto' }}>
