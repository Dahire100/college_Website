...
export default function StudentLife({ settings = {}, onNavigate }) {
  ...
  return (
    <div>
      <div style={{ background: pageData?.heroImageUrl ? `linear-gradient(rgba(11, 37, 69, 0.85), rgba(19, 62, 104, 0.9)), url(${pageData.heroImageUrl}) center/cover no-repeat` : 'var(--color-primary)', color: '#FFFFFF', padding: '5rem 0 4rem 0', position: 'relative' }}>
